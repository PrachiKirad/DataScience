From: <Saved by Blink>
Snapshot-Content-Location: http://localhost:8888/tree
Subject: Home
Date: Sat, 17 Dec 2022 09:42:07 -0000
MIME-Version: 1.0
Content-Type: multipart/related;
	type="text/html";
	boundary="----MultipartBoundary--IFfkoyuFauVKtgBIsg1vEZ4uBSmhqhNPhyzJU9QnKb----"


------MultipartBoundary--IFfkoyuFauVKtgBIsg1vEZ4uBSmhqhNPhyzJU9QnKb----
Content-Type: text/html
Content-ID: <frame-11A6008CB43A02D26FF66F32D638D3C9@mhtml.blink>
Content-Transfer-Encoding: quoted-printable
Content-Location: http://localhost:8888/tree
...
<!DOCTYPE html><html lang=3D"en-us"><head><meta http-equiv=3D"Content-Type"=
 content=3D"text/html; charset=3DUTF-8">
   =20
    ...
    <title>Home</title>
    <link id=3D"favicon" rel=3D"shortcut icon" type=3D"image/x-icon" href=
=3D"http://localhost:8888/static/base/images/favicon.ico?v=3D50afa725b5de8b=
00030139d09b38620224d4e7dba47c07ef0e86d4643f30c9bfe6bb7e1a4a1c561aa32834480=
909a4b6fe7cd1e17f7159330b6b5914bf45a880">
...
<body class=3D"" data-jupyter-api-token=3D"2d551fecce133f37b05a9c4b4d93e92c=
b6f8f5f37cb0ab66" data-base-url=3D"/" data-notebook-path=3D"" data-terminal=
s-available=3D"True" data-server-root=3D"C:\Users\Pranav" dir=3D"ltr">
...
/localhost:8888/tree?token=3D2d551fecce133f37b05a9c4b4d93e92cb6f8f5f37cb0ab=
66" title=3D"dashboard">
...
">
 ...
 =20
  <span class=3D"flex-spacer"></span>
 =20
 =20
 =20
    <span id=3D"shutdown_widget">
      <button id=3D"shutdown" class=3D"btn btn-sm navbar-btn" title=3D"Stop=
 the Jupyter server">
          Quit
      </button>
    </span>
...
<div id=3D"site" style=3D"display: block; height: 709px;">


  <div id=3D"ipython-main-app" class=3D"container">
    <div id=3D"tab_content" class=3D"tabbable" role=3D"main">
      <ul id=3D"tabs" class=3D"nav nav-tabs">
        <li class=3D"active"><a href=3D"http://localhost:8888/tree#notebook=
s" data-toggle=3D"tab">Files</a></li>
        <li><a href=3D"http://localhost:8888/tree#running" data-toggle=3D"t=
ab">Running</a></li>
        <li><a href=3D"http://localhost:8888/tree#clusters" data-toggle=3D"=
tab" class=3D"clusters_tab_link">Clusters</a></li>
      </ul>
      <div class=3D"tab-content">
        <div id=3D"notebooks" class=3D"tab-pane active">
          <div id=3D"notebook_toolbar" class=3D"row list_toolbar">
            <div class=3D"col-sm-8 no-padding">
              <div class=3D"dynamic-instructions" style=3D"display: none;">
                Select items to perform actions on them.
              </div>
              <div class=3D"dynamic-buttons">
                  <button title=3D"Duplicate selected" aria-label=3D"Duplic=
ate selected" class=3D"duplicate-button btn btn-default btn-xs" aria-descri=
bedby=3D"tooltip1" style=3D"display: inline-block;">Duplicate </button>
                  <div role=3D"tooltip" id=3D"tooltip1">Duplicate selected<=
/div>
                  <button title=3D"Rename selected" aria-label=3D"Rename se=
lected" class=3D"rename-button btn btn-default btn-xs" aria-describedby=3D"=
tooltip2" style=3D"display: inline-block;">Rename</button>
                  <div role=3D"tooltip" id=3D"tooltip2">Rename selected</di=
v>=20
                  <button title=3D"Move selected" aria-label=3D"Move select=
ed" class=3D"move-button btn btn-default btn-xs" aria-describedby=3D"toolti=
p3" style=3D"display: inline-block;">Move</button>
                  <div role=3D"tooltip" id=3D"tooltip3">Move selected</div>=
=20
                  <button title=3D"Download selected" aria-label=3D"Downloa=
d selected" class=3D"download-button btn btn-default btn-xs" aria-described=
by=3D"tooltip4" style=3D"display: inline-block;">Download</button>
                  <div role=3D"tooltip" id=3D"tooltip4">Download selected</=
div>
                  <button title=3D"Shutdown selected notebook(s)" aria-labe=
l=3D"Shutdown selected notebook(s)" class=3D"shutdown-button btn btn-defaul=
t btn-xs btn-warning" aria-describedby=3D"tooltip5" style=3D"display: none;=
">Shutdown</button>
                  <div role=3D"tooltip" id=3D"tooltip5">Shutdown selected n=
otebook(s)</div> =20
                  <button title=3D"View selected" aria-label=3D"View select=
ed" class=3D"view-button btn btn-default btn-xs" aria-describedby=3D"toolti=
p6" style=3D"display: inline-block;">View</button>
                  <div role=3D"tooltip" id=3D"tooltip6">View selected</div>=
=20
                  <button title=3D"Edit selected" aria-label=3D"Edit select=
ed" class=3D"edit-button btn btn-default btn-xs" aria-describedby=3D"toolti=
p7" style=3D"display: inline-block;">Edit</button>
                  <div role=3D"tooltip" id=3D"tooltip7">Edit selected</div>=
 =20
                  <button title=3D"Delete selected" aria-label=3D"Delete se=
lected" class=3D"delete-button btn btn-default btn-xs btn-danger" aria-desc=
ribedby=3D"tooltip8" style=3D"display: inline-block;">
                    <i class=3D"fa fa-trash"></i>
                  </button>
                  <div role=3D"tooltip" id=3D"tooltip8">Delete selected</di=
v>
              </div>
            </div>
            <div class=3D"col-sm-4 no-padding tree-buttons">
              <div class=3D"pull-right">
                <form id=3D"alternate_upload" class=3D"alternate_upload">
                  <span id=3D"notebook_list_info" class=3D"toolbar_info">
                  <span id=3D"upload_span" class=3D"btn btn-xs btn-default =
btn-upload" role=3D"button" tabindex=3D"0">
                    <input id=3D"upload_span_input" title=3D"Click to brows=
e for a file to upload." type=3D"file" name=3D"datafile" class=3D"fileinput=
" multiple=3D"multiple" tabindex=3D"-1">
                    Upload
                  </span>
                  </span>
                </form>
                <div id=3D"new-buttons" class=3D"btn-group">
                  <button class=3D"dropdown-toggle btn btn-default btn-xs" =
id=3D"new-dropdown-button" data-toggle=3D"dropdown">
                  <span>New</span>
                  <span class=3D"caret"></span>
                  <span class=3D"sr-only">Toggle Dropdown</span>
                  </button>
                  <ul id=3D"new-menu" class=3D"dropdown-menu" role=3D"menu"=
>
                    <li role=3D"menuitem" class=3D"dropdown-header" id=3D"n=
otebook-kernels">Notebook:</li><li id=3D"kernel-python3"><a aria-label=3D"p=
ython3" role=3D"menuitem" href=3D"http://localhost:8888/tree#" title=3D"Cre=
ate a new notebook with Python 3 (ipykernel)">Python 3 (ipykernel)</a></li>
                    <li role=3D"presentation" class=3D"divider"></li>
                    <li role=3D"menuitem" class=3D"dropdown-header">Other:<=
/li>
                    <li role=3D"none" id=3D"new-file">
                        <a role=3D"menuitem" tabindex=3D"-1" href=3D"http:/=
/localhost:8888/tree#">Text File</a>
                    </li>
                    <li role=3D"none" id=3D"new-folder">
                        <a role=3D"menuitem" tabindex=3D"-1" href=3D"http:/=
/localhost:8888/tree#">Folder</a>
                    </li>
                   =20
                    <li role=3D"none" id=3D"new-terminal">
                        <a role=3D"menuitem" tabindex=3D"-1" href=3D"http:/=
/localhost:8888/tree#">Terminal</a>
                    </li>
                   =20
                  </ul>
                </div>
                <div class=3D"btn-group">
                    <button id=3D"refresh_notebook_list" title=3D"Refresh n=
otebook list" aria-label=3D"Refresh notebook list" class=3D"btn btn-default=
 btn-xs"><i class=3D"fa fa-refresh"></i></button>
                </div>
              </div>
            </div>
          </div>
          <div id=3D"notebook_list" class=3D"list_container">
            <div id=3D"notebook_list_header" class=3D"row list_header">
              <div class=3D"btn-group dropdown" id=3D"tree-selector">
                <button title=3D"Select All / None" aria-label=3D"Selected,=
 1 items" type=3D"button" class=3D"btn btn-default btn-xs" id=3D"button-sel=
ect-all" role=3D"checkbox">
                  <input type=3D"checkbox" class=3D"pull-left tree-selector=
" id=3D"select-all" tabindex=3D"-1"><span id=3D"counter-select-all">1</span=
>
                </button>
                <button title=3D"Select Folders/All Notebooks/Running/Files=
" class=3D"btn btn-default btn-xs dropdown-toggle" type=3D"button" id=3D"tr=
ee-selector-btn" data-toggle=3D"dropdown" aria-expanded=3D"false">
                  <span class=3D"sr-only">checkbox</span>
                  <span class=3D"caret"></span>
                  <span class=3D"sr-only">Toggle Dropdown</span>
                </button>
                <ul id=3D"selector-menu" class=3D"dropdown-menu" role=3D"me=
nu" aria-labelledby=3D"tree-selector-btn">
                  <li role=3D"none"><a id=3D"select-folders" role=3D"menuit=
em" tabindex=3D"-1" href=3D"http://localhost:8888/tree#" title=3D"Select Al=
l Folders"><i class=3D"menu_icon folder_icon icon-fixed-width"></i>&nbsp;Fo=
lders</a></li>
                  <li role=3D"none"><a id=3D"select-notebooks" role=3D"menu=
item" tabindex=3D"-1" href=3D"http://localhost:8888/tree#" title=3D"Select =
All Notebooks"><i class=3D"menu_icon notebook_icon icon-fixed-width"></i>&n=
bsp;All Notebooks</a></li>
                  <li role=3D"none"><a id=3D"select-running-notebooks" role=
=3D"menuitem" tabindex=3D"-1" href=3D"http://localhost:8888/tree#" title=3D=
"Select Running Notebooks"><i class=3D"menu_icon running_notebook_icon icon=
-fixed-width"></i>&nbsp;Running</a></li>
                  <li role=3D"none"><a id=3D"select-files" role=3D"menuitem=
" tabindex=3D"-1" href=3D"http://localhost:8888/tree#" title=3D"Select All =
Files"><i class=3D"menu_icon file_icon icon-fixed-width"></i>&nbsp;Files</a=
></li>
                </ul>
              </div>
              <div id=3D"project_name">
                <ul class=3D"breadcrumb"><li><a href=3D"http://localhost:88=
88/tree" title=3D"Link to root folder"><i class=3D"fa fa-folder"></i></a></=
li><li><a href=3D"http://localhost:8888/tree"></a></li></ul>
              </div>
              <div id=3D"sort_buttons" class=3D"pull-right">
                <div id=3D"sort_name" class=3D"sort_button">
                  <button type=3D"button" class=3D"btn btn-xs btn-default s=
ort-action" id=3D"sort-name" aria-label=3D"Sort by name">
                        Name
                        <i class=3D"fa fa-arrow-down"></i>
                  </button>
                </div>
                <div id=3D"last_modified" class=3D"sort_button">
                    <button type=3D"button" class=3D"btn btn-xs btn-default=
 sort-action" id=3D"last-modified" aria-label=3D"Sort by last modified">
                        Last Modified
                        <i class=3D"fa"></i>
                    </button>
                </div>
                <div id=3D"file_size" class=3D"sort_button">
                    <button type=3D"button" class=3D"btn btn-xs btn-default=
 sort-action" id=3D"file-size" aria-label=3D"Sort by file size">
                        File size
                        <i class=3D"fa"></i>
                    </button>
                </div>
              </div>
            </div><div class=3D"list_item row"><div class=3D"col-md-12"><in=
put type=3D"checkbox" title=3D"Click here to rename, delete, etc."><i class=
=3D"item_icon folder_icon icon-fixed-width"></i><a class=3D"item_link" href=
=3D"http://localhost:8888/tree/anaconda3"><span class=3D"item_name">anacond=
a3</span></a><div class=3D"pull-right"><div class=3D"item_buttons pull-left=
"><div class=3D"running-indicator" style=3D"visibility: hidden;">Running</d=
iv></div><div class=3D"pull-right"><span class=3D"item_modified pull-left" =
title=3D"2022-10-02 20:08">2 months ago</span><span class=3D"file_size pull=
-right">&nbsp;</span></div></div></div></div><div class=3D"list_item row"><=
div class=3D"col-md-12"><input type=3D"checkbox" title=3D"Click here to ren=
ame, delete, etc."><i class=3D"item_icon folder_icon icon-fixed-width"></i>=
<a class=3D"item_link" href=3D"http://localhost:8888/tree/Contacts"><span c=
lass=3D"item_name">Contacts</span></a><div class=3D"pull-right"><div class=
=3D"item_buttons pull-left"><div class=3D"running-indicator" style=3D"visib=
ility: hidden;">Running</div></div><div class=3D"pull-right"><span class=3D=
"item_modified pull-left" title=3D"2022-12-11 12:10">6 days ago</span><span=
 class=3D"file_size pull-right">&nbsp;</span></div></div></div></div><div c=
lass=3D"list_item row"><div class=3D"col-md-12"><input type=3D"checkbox" ti=
tle=3D"Click here to rename, delete, etc."><i class=3D"item_icon folder_ico=
n icon-fixed-width"></i><a class=3D"item_link" href=3D"http://localhost:888=
8/tree/Desktop"><span class=3D"item_name">Desktop</span></a><div class=3D"p=
ull-right"><div class=3D"item_buttons pull-left"><div class=3D"running-indi=
cator" style=3D"visibility: hidden;">Running</div></div><div class=3D"pull-=
right"><span class=3D"item_modified pull-left" title=3D"2022-12-13 12:38">4=
 days ago</span><span class=3D"file_size pull-right">&nbsp;</span></div></d=
iv></div></div><div class=3D"list_item row"><div class=3D"col-md-12"><input=
 type=3D"checkbox" title=3D"Click here to rename, delete, etc."><i class=3D=
"item_icon folder_icon icon-fixed-width"></i><a class=3D"item_link" href=3D=
"http://localhost:8888/tree/DLLs"><span class=3D"item_name">DLLs</span></a>=
<div class=3D"pull-right"><div class=3D"item_buttons pull-left"><div class=
=3D"running-indicator" style=3D"visibility: hidden;">Running</div></div><di=
v class=3D"pull-right"><span class=3D"item_modified pull-left" title=3D"202=
2-10-02 15:25">2 months ago</span><span class=3D"file_size pull-right">&nbs=
p;</span></div></div></div></div><div class=3D"list_item row"><div class=3D=
"col-md-12"><input type=3D"checkbox" title=3D"Click here to rename, delete,=
 etc."><i class=3D"item_icon folder_icon icon-fixed-width"></i><a class=3D"=
item_link" href=3D"http://localhost:8888/tree/Doc"><span class=3D"item_name=
">Doc</span></a><div class=3D"pull-right"><div class=3D"item_buttons pull-l=
eft"><div class=3D"running-indicator" style=3D"visibility: hidden;">Running=
</div></div><div class=3D"pull-right"><span class=3D"item_modified pull-lef=
t" title=3D"2022-10-02 15:25">2 months ago</span><span class=3D"file_size p=
ull-right">&nbsp;</span></div></div></div></div><div class=3D"list_item row=
"><div class=3D"col-md-12"><input type=3D"checkbox" title=3D"Click here to =
rename, delete, etc."><i class=3D"item_icon folder_icon icon-fixed-width"><=
/i><a class=3D"item_link" href=3D"http://localhost:8888/tree/Documents"><sp=
an class=3D"item_name">Documents</span></a><div class=3D"pull-right"><div c=
lass=3D"item_buttons pull-left"><div class=3D"running-indicator" style=3D"v=
isibility: hidden;">Running</div></div><div class=3D"pull-right"><span clas=
s=3D"item_modified pull-left" title=3D"2022-12-11 12:10">6 days ago</span><=
span class=3D"file_size pull-right">&nbsp;</span></div></div></div></div><d=
iv class=3D"list_item row"><div class=3D"col-md-12"><input type=3D"checkbox=
" title=3D"Click here to rename, delete, etc."><i class=3D"item_icon folder=
_icon icon-fixed-width"></i><a class=3D"item_link" href=3D"http://localhost=
:8888/tree/Downloads"><span class=3D"item_name">Downloads</span></a><div cl=
ass=3D"pull-right"><div class=3D"item_buttons pull-left"><div class=3D"runn=
ing-indicator" style=3D"visibility: hidden;">Running</div></div><div class=
=3D"pull-right"><span class=3D"item_modified pull-left" title=3D"2022-12-13=
 13:42">4 days ago</span><span class=3D"file_size pull-right">&nbsp;</span>=
</div></div></div></div><div class=3D"list_item row"><div class=3D"col-md-1=
2"><input type=3D"checkbox" title=3D"Click here to rename, delete, etc."><i=
 class=3D"item_icon folder_icon icon-fixed-width"></i><a class=3D"item_link=
" href=3D"http://localhost:8888/tree/Dropbox"><span class=3D"item_name">Dro=
pbox</span></a><div class=3D"pull-right"><div class=3D"item_buttons pull-le=
ft"><div class=3D"running-indicator" style=3D"visibility: hidden;">Running<=
/div></div><div class=3D"pull-right"><span class=3D"item_modified pull-left=
" title=3D"2022-10-02 13:10">2 months ago</span><span class=3D"file_size pu=
ll-right">&nbsp;</span></div></div></div></div><div class=3D"list_item row"=
><div class=3D"col-md-12"><input type=3D"checkbox" title=3D"Click here to r=
ename, delete, etc."><i class=3D"item_icon folder_icon icon-fixed-width"></=
i><a class=3D"item_link" href=3D"http://localhost:8888/tree/Favorites"><spa=
n class=3D"item_name">Favorites</span></a><div class=3D"pull-right"><div cl=
ass=3D"item_buttons pull-left"><div class=3D"running-indicator" style=3D"vi=
sibility: hidden;">Running</div></div><div class=3D"pull-right"><span class=
=3D"item_modified pull-left" title=3D"2022-12-11 12:10">6 days ago</span><s=
pan class=3D"file_size pull-right">&nbsp;</span></div></div></div></div><di=
v class=3D"list_item row"><div class=3D"col-md-12"><input type=3D"checkbox"=
 title=3D"Click here to rename, delete, etc."><i class=3D"item_icon folder_=
icon icon-fixed-width"></i><a class=3D"item_link" href=3D"http://localhost:=
8888/tree/include"><span class=3D"item_name">include</span></a><div class=
=3D"pull-right"><div class=3D"item_buttons pull-left"><div class=3D"running=
-indicator" style=3D"visibility: hidden;">Running</div></div><div class=3D"=
pull-right"><span class=3D"item_modified pull-left" title=3D"2022-10-02 15:=
24">2 months ago</span><span class=3D"file_size pull-right">&nbsp;</span></=
div></div></div></div><div class=3D"list_item row"><div class=3D"col-md-12"=
><input type=3D"checkbox" title=3D"Click here to rename, delete, etc."><i c=
lass=3D"item_icon folder_icon icon-fixed-width"></i><a class=3D"item_link" =
href=3D"http://localhost:8888/tree/Jedi"><span class=3D"item_name">Jedi</sp=
an></a><div class=3D"pull-right"><div class=3D"item_buttons pull-left"><div=
 class=3D"running-indicator" style=3D"visibility: hidden;">Running</div></d=
iv><div class=3D"pull-right"><span class=3D"item_modified pull-left" title=
=3D"2022-10-08 12:27">2 months ago</span><span class=3D"file_size pull-righ=
t">&nbsp;</span></div></div></div></div><div class=3D"list_item row"><div c=
lass=3D"col-md-12"><input type=3D"checkbox" title=3D"Click here to rename, =
delete, etc."><i class=3D"item_icon folder_icon icon-fixed-width"></i><a cl=
ass=3D"item_link" href=3D"http://localhost:8888/tree/Lib"><span class=3D"it=
em_name">Lib</span></a><div class=3D"pull-right"><div class=3D"item_buttons=
 pull-left"><div class=3D"running-indicator" style=3D"visibility: hidden;">=
Running</div></div><div class=3D"pull-right"><span class=3D"item_modified p=
ull-left" title=3D"2022-10-02 15:25">2 months ago</span><span class=3D"file=
_size pull-right">&nbsp;</span></div></div></div></div><div class=3D"list_i=
tem row"><div class=3D"col-md-12"><input type=3D"checkbox" title=3D"Click h=
ere to rename, delete, etc."><i class=3D"item_icon folder_icon icon-fixed-w=
idth"></i><a class=3D"item_link" href=3D"http://localhost:8888/tree/libs"><=
span class=3D"item_name">libs</span></a><div class=3D"pull-right"><div clas=
s=3D"item_buttons pull-left"><div class=3D"running-indicator" style=3D"visi=
bility: hidden;">Running</div></div><div class=3D"pull-right"><span class=
=3D"item_modified pull-left" title=3D"2022-10-02 15:25">2 months ago</span>=
<span class=3D"file_size pull-right">&nbsp;</span></div></div></div></div><=
div class=3D"list_item row"><div class=3D"col-md-12"><input type=3D"checkbo=
x" title=3D"Click here to rename, delete, etc."><i class=3D"item_icon folde=
r_icon icon-fixed-width"></i><a class=3D"item_link" href=3D"http://localhos=
t:8888/tree/Links"><span class=3D"item_name">Links</span></a><div class=3D"=
pull-right"><div class=3D"item_buttons pull-left"><div class=3D"running-ind=
icator" style=3D"visibility: hidden;">Running</div></div><div class=3D"pull=
-right"><span class=3D"item_modified pull-left" title=3D"2022-12-11 12:10">=
6 days ago</span><span class=3D"file_size pull-right">&nbsp;</span></div></=
div></div></div><div class=3D"list_item row"><div class=3D"col-md-12"><inpu=
t type=3D"checkbox" title=3D"Click here to rename, delete, etc."><i class=
=3D"item_icon folder_icon icon-fixed-width"></i><a class=3D"item_link" href=
=3D"http://localhost:8888/tree/Music"><span class=3D"item_name">Music</span=
></a><div class=3D"pull-right"><div class=3D"item_buttons pull-left"><div c=
lass=3D"running-indicator" style=3D"visibility: hidden;">Running</div></div=
><div class=3D"pull-right"><span class=3D"item_modified pull-left" title=3D=
"2022-12-11 12:10">6 days ago</span><span class=3D"file_size pull-right">&n=
bsp;</span></div></div></div></div><div class=3D"list_item row"><div class=
=3D"col-md-12"><input type=3D"checkbox" title=3D"Click here to rename, dele=
te, etc."><i class=3D"item_icon folder_icon icon-fixed-width"></i><a class=
=3D"item_link" href=3D"http://localhost:8888/tree/OneDrive"><span class=3D"=
item_name">OneDrive</span></a><div class=3D"pull-right"><div class=3D"item_=
buttons pull-left"><div class=3D"running-indicator" style=3D"visibility: hi=
dden;">Running</div></div><div class=3D"pull-right"><span class=3D"item_mod=
ified pull-left" title=3D"2022-12-17 14:46">26 minutes ago</span><span clas=
s=3D"file_size pull-right">&nbsp;</span></div></div></div></div><div class=
=3D"list_item row"><div class=3D"col-md-12"><input type=3D"checkbox" title=
=3D"Click here to rename, delete, etc."><i class=3D"item_icon folder_icon i=
con-fixed-width"></i><a class=3D"item_link" href=3D"http://localhost:8888/t=
ree/Pictures"><span class=3D"item_name">Pictures</span></a><div class=3D"pu=
ll-right"><div class=3D"item_buttons pull-left"><div class=3D"running-indic=
ator" style=3D"visibility: hidden;">Running</div></div><div class=3D"pull-r=
ight"><span class=3D"item_modified pull-left" title=3D"2022-12-11 12:10">6 =
days ago</span><span class=3D"file_size pull-right">&nbsp;</span></div></di=
v></div></div><div class=3D"list_item row"><div class=3D"col-md-12"><input =
type=3D"checkbox" title=3D"Click here to rename, delete, etc."><i class=3D"=
item_icon folder_icon icon-fixed-width"></i><a class=3D"item_link" href=3D"=
http://localhost:8888/tree/Python"><span class=3D"item_name">Python</span><=
/a><div class=3D"pull-right"><div class=3D"item_buttons pull-left"><div cla=
ss=3D"running-indicator" style=3D"visibility: hidden;">Running</div></div><=
div class=3D"pull-right"><span class=3D"item_modified pull-left" title=3D"2=
022-10-02 15:30">2 months ago</span><span class=3D"file_size pull-right">&n=
bsp;</span></div></div></div></div><div class=3D"list_item row"><div class=
=3D"col-md-12"><input type=3D"checkbox" title=3D"Click here to rename, dele=
te, etc."><i class=3D"item_icon folder_icon icon-fixed-width"></i><a class=
=3D"item_link" href=3D"http://localhost:8888/tree/Saved%20Games"><span clas=
s=3D"item_name">Saved Games</span></a><div class=3D"pull-right"><div class=
=3D"item_buttons pull-left"><div class=3D"running-indicator" style=3D"visib=
ility: hidden;">Running</div></div><div class=3D"pull-right"><span class=3D=
"item_modified pull-left" title=3D"2022-12-11 12:10">6 days ago</span><span=
 class=3D"file_size pull-right">&nbsp;</span></div></div></div></div><div c=
...
tle=3D"Click here to rename, delete, etc."><i class=3D"item_icon folder_ico=
n icon-fixed-width"></i><a class=3D"item_link" href=3D"http://localhost:888=
8/tree/Scripts"><span class=3D"item_name">Scripts</span></a><div class=3D"p=
ull-right"><div class=3D"item_buttons pull-left"><div class=3D"running-indi=
cator" style=3D"visibility: hidden;">Running</div></div><div class=3D"pull-=
right"><span class=3D"item_modified pull-left" title=3D"2022-10-02 15:26">2=
 months ago</span><span class=3D"file_size pull-right">&nbsp;</span></div><=
/div></div></div><div class=3D"list_item row"><div class=3D"col-md-12"><inp=
ut type=3D"checkbox" title=3D"Click here to rename, delete, etc."><i class=
=3D"item_icon folder_icon icon-fixed-width"></i><a class=3D"item_link" href=
=3D"http://localhost:8888/tree/seaborn-data"><span class=3D"item_name">seab=
orn-data</span></a><div class=3D"pull-right"><div class=3D"item_buttons pul=
l-left"><div class=3D"running-indicator" style=3D"visibility: hidden;">Runn=
ing</div></div><div class=3D"pull-right"><span class=3D"item_modified pull-=
left" title=3D"2022-11-11 19:04">a month ago</span><span class=3D"file_size=
 pull-right">&nbsp;</span></div></div></div></div><div class=3D"list_item r=
ow"><div class=3D"col-md-12"><input type=3D"checkbox" title=3D"Click here t=
o rename, delete, etc."><i class=3D"item_icon folder_icon icon-fixed-width"=
></i><a class=3D"item_link" href=3D"http://localhost:8888/tree/Searches"><s=
pan class=3D"item_name">Searches</span></a><div class=3D"pull-right"><div c=
lass=3D"item_buttons pull-left"><div class=3D"running-indicator" style=3D"v=
isibility: hidden;">Running</div></div><div class=3D"pull-right"><span clas=
s=3D"item_modified pull-left" title=3D"2022-12-11 12:10">6 days ago</span><=
span class=3D"file_size pull-right">&nbsp;</span></div></div></div></div><d=
...
" title=3D"Click here to rename, delete, etc."><i class=3D"item_icon folder=
_icon icon-fixed-width"></i><a class=3D"item_link" href=3D"http://localhost=
:8888/tree/tcl"><span class=3D"item_name">tcl</span></a><div class=3D"pull-=
right"><div class=3D"item_buttons pull-left"><div class=3D"running-indicato=
r" style=3D"visibility: hidden;">Running</div></div><div class=3D"pull-righ=
t"><span class=3D"item_modified pull-left" title=3D"2022-10-02 15:25">2 mon=
ths ago</span><span class=3D"file_size pull-right">&nbsp;</span></div></div=
></div></div><div class=3D"list_item row"><div class=3D"col-md-12"><input t=
ype=3D"checkbox" title=3D"Click here to rename, delete, etc."><i class=3D"i=
tem_icon folder_icon icon-fixed-width"></i><a class=3D"item_link" href=3D"h=
ttp://localhost:8888/tree/Tools"><span class=3D"item_name">Tools</span></a>=
<div class=3D"pull-right"><div class=3D"item_buttons pull-left"><div class=
=3D"running-indicator" style=3D"visibility: hidden;">Running</div></div><di=
v class=3D"pull-right"><span class=3D"item_modified pull-left" title=3D"202=
2-10-02 15:25">2 months ago</span><span class=3D"file_size pull-right">&nbs=
...
"col-md-12"><input type=3D"checkbox" title=3D"Click here to rename, delete,=
 etc."><i class=3D"item_icon folder_icon icon-fixed-width"></i><a class=3D"=
item_link" href=3D"http://localhost:8888/tree/Videos"><span class=3D"item_n=
ame">Videos</span></a><div class=3D"pull-right"><div class=3D"item_buttons =
pull-left"><div class=3D"running-indicator" style=3D"visibility: hidden;">R=
unning</div></div><div class=3D"pull-right"><span class=3D"item_modified pu=
ll-left" title=3D"2022-12-11 12:10">6 days ago</span><span class=3D"file_si=
ze pull-right">&nbsp;</span></div></div></div></div><div class=3D"list_item=
 row"><div class=3D"col-md-12"><input type=3D"checkbox" title=3D"Click here=
 to rename, delete, etc."><i class=3D"item_icon notebook_icon icon-fixed-wi=
dth"></i><a class=3D"item_link" href=3D"http://localhost:8888/notebooks/Clu=
ster.ipynb" target=3D"_blank"><span class=3D"item_name">Cluster.ipynb</span=
></a><div class=3D"pull-right"><div class=3D"item_buttons pull-left"><div c=
lass=3D"running-indicator" style=3D"visibility: hidden;">Running</div></div=
><div class=3D"pull-right"><span class=3D"item_modified pull-left" title=3D=
"2022-10-09 12:39">2 months ago</span><span class=3D"file_size pull-right">=
275 kB</span></div></div></div></div><div class=3D"list_item row"><div clas=
s=3D"col-md-12"><input type=3D"checkbox" title=3D"Click here to rename, del=
ete, etc."><i class=3D"item_icon notebook_icon icon-fixed-width"></i><a cla=
ss=3D"item_link" href=3D"http://localhost:8888/notebooks/Data%20pre-process=
ing%20.ipynb" target=3D"_blank"><span class=3D"item_name">Data pre-processi=
ng .ipynb</span></a><div class=3D"pull-right"><div class=3D"item_buttons pu=
ll-left"><div class=3D"running-indicator" style=3D"visibility: hidden;">Run=
ning</div></div><div class=3D"pull-right"><span class=3D"item_modified pull=
-left" title=3D"2022-12-01 12:29">16 days ago</span><span class=3D"file_siz=
e pull-right">32 kB</span></div></div></div></div><div class=3D"list_item r=
ow"><div class=3D"col-md-12"><input type=3D"checkbox" title=3D"Click here t=
o rename, delete, etc."><i class=3D"item_icon notebook_icon icon-fixed-widt=
h"></i><a class=3D"item_link" href=3D"http://localhost:8888/notebooks/datac=
leaning%20-titanic.ipynb" target=3D"_blank"><span class=3D"item_name">datac=
leaning -titanic.ipynb</span></a><div class=3D"pull-right"><div class=3D"it=
em_buttons pull-left"><div class=3D"running-indicator" style=3D"visibility:=
 hidden;">Running</div></div><div class=3D"pull-right"><span class=3D"item_=
modified pull-left" title=3D"2022-11-13 10:13">a month ago</span><span clas=
s=3D"file_size pull-right">945 kB</span></div></div></div></div><div class=
=3D"list_item row"><div class=3D"col-md-12"><input type=3D"checkbox" title=
=3D"Click here to rename, delete, etc."><i class=3D"item_icon notebook_icon=
 icon-fixed-width"></i><a class=3D"item_link" href=3D"http://localhost:8888=
/notebooks/exam.ipynb" target=3D"_blank"><span class=3D"item_name">exam.ipy=
nb</span></a><div class=3D"pull-right"><div class=3D"item_buttons pull-left=
"><div class=3D"running-indicator" style=3D"visibility: hidden;">Running</d=
iv></div><div class=3D"pull-right"><span class=3D"item_modified pull-left" =
title=3D"2022-11-11 18:36">a month ago</span><span class=3D"file_size pull-=
right">5.67 kB</span></div></div></div></div><div class=3D"list_item row"><=
div class=3D"col-md-12"><input type=3D"checkbox" title=3D"Click here to ren=
ame, delete, etc."><i class=3D"item_icon notebook_icon icon-fixed-width"></=
i><a class=3D"item_link" href=3D"http://localhost:8888/notebooks/loan%26app=
licant.ipynb" target=3D"_blank"><span class=3D"item_name">loan&amp;applican=
t.ipynb</span></a><div class=3D"pull-right"><div class=3D"item_buttons pull=
-left"><div class=3D"running-indicator" style=3D"visibility: hidden;">Runni=
ng</div></div><div class=3D"pull-right"><span class=3D"item_modified pull-l=
eft" title=3D"2022-11-18 20:02">a month ago</span><span class=3D"file_size =
pull-right">24.9 kB</span></div></div></div></div><div class=3D"list_item r=
ow"><div class=3D"col-md-12"><input type=3D"checkbox" title=3D"Click here t=
o rename, delete, etc."><i class=3D"item_icon running_notebook_icon icon-fi=
xed-width"></i><a class=3D"item_link" href=3D"http://localhost:8888/noteboo=
ks/Movie_Recommender_system.ipynb" target=3D"_blank"><span class=3D"item_na=
me">Movie_Recommender_system.ipynb</span></a><div class=3D"pull-right"><div=
 class=3D"item_buttons pull-left"><div class=3D"running-indicator" style=3D=
"">Running</div></div><div class=3D"pull-right"><span class=3D"item_modifie=
d pull-left" title=3D"2022-12-11 13:26">6 days ago</span><span class=3D"fil=
e_size pull-right">280 kB</span></div></div></div></div><div class=3D"list_=
item row"><div class=3D"col-md-12"><input type=3D"checkbox" title=3D"Click =
here to rename, delete, etc."><i class=3D"item_icon notebook_icon icon-fixe=
d-width"></i><a class=3D"item_link" href=3D"http://localhost:8888/notebooks=
/Movierecommendation.ipynb" target=3D"_blank"><span class=3D"item_name">Mov=
ierecommendation.ipynb</span></a><div class=3D"pull-right"><div class=3D"it=
em_buttons pull-left"><div class=3D"running-indicator" style=3D"visibility:=
 hidden;">Running</div></div><div class=3D"pull-right"><span class=3D"item_=
modified pull-left" title=3D"2022-12-17 15:08">4 minutes ago</span><span cl=
ass=3D"file_size pull-right">261 kB</span></div></div></div></div><div clas=
s=3D"list_item row"><div class=3D"col-md-12"><input type=3D"checkbox" title=
=3D"Click here to rename, delete, etc."><i class=3D"item_icon notebook_icon=
 icon-fixed-width"></i><a class=3D"item_link" href=3D"http://localhost:8888=
/notebooks/practical2.ipynb" target=3D"_blank"><span class=3D"item_name">pr=
actical2.ipynb</span></a><div class=3D"pull-right"><div class=3D"item_butto=
ns pull-left"><div class=3D"running-indicator" style=3D"visibility: hidden;=
">Running</div></div><div class=3D"pull-right"><span class=3D"item_modified=
 pull-left" title=3D"2022-11-11 22:32">a month ago</span><span class=3D"fil=
e_size pull-right">11.9 kB</span></div></div></div></div><div class=3D"list=
_item row"><div class=3D"col-md-12"><input type=3D"checkbox" title=3D"Click=
 here to rename, delete, etc."><i class=3D"item_icon notebook_icon icon-fix=
ed-width"></i><a class=3D"item_link" href=3D"http://localhost:8888/notebook=
s/Python%20game.ipynb" target=3D"_blank"><span class=3D"item_name">Python g=
ame.ipynb</span></a><div class=3D"pull-right"><div class=3D"item_buttons pu=
ll-left"><div class=3D"running-indicator" style=3D"visibility: hidden;">Run=
ning</div></div><div class=3D"pull-right"><span class=3D"item_modified pull=
-left" title=3D"2022-12-12 14:43">5 days ago</span><span class=3D"file_size=
 pull-right">2.63 kB</span></div></div></div></div><div class=3D"list_item =
row"><div class=3D"col-md-12"><input type=3D"checkbox" title=3D"Click here =
to rename, delete, etc."><i class=3D"item_icon running_notebook_icon icon-f=
ixed-width"></i><a class=3D"item_link" href=3D"http://localhost:8888/notebo=
oks/Untitled.ipynb" target=3D"_blank"><span class=3D"item_name">Untitled.ip=
ynb</span></a><div class=3D"pull-right"><div class=3D"item_buttons pull-lef=
t"><div class=3D"running-indicator" style=3D"">Running</div></div><div clas=
s=3D"pull-right"><span class=3D"item_modified pull-left" title=3D"2022-12-1=
6 10:57">a day ago</span><span class=3D"file_size pull-right">589 B</span><=
/div></div></div></div><div class=3D"list_item row"><div class=3D"col-md-12=
"><input type=3D"checkbox" title=3D"Click here to rename, delete, etc."><i =
class=3D"item_icon notebook_icon icon-fixed-width"></i><a class=3D"item_lin=
k" href=3D"http://localhost:8888/notebooks/Untitled1.ipynb" target=3D"_blan=
k"><span class=3D"item_name">Untitled1.ipynb</span></a><div class=3D"pull-r=
ight"><div class=3D"item_buttons pull-left"><div class=3D"running-indicator=
" style=3D"visibility: hidden;">Running</div></div><div class=3D"pull-right=
"><span class=3D"item_modified pull-left" title=3D"2022-11-26 10:19">21 day=
s ago</span><span class=3D"file_size pull-right">1.32 kB</span></div></div>=
</div></div><div class=3D"list_item row"><div class=3D"col-md-12"><input ty=
pe=3D"checkbox" title=3D"Click here to rename, delete, etc."><i class=3D"it=
em_icon notebook_icon icon-fixed-width"></i><a class=3D"item_link" href=3D"=
http://localhost:8888/notebooks/weather.ipynb" target=3D"_blank"><span clas=
s=3D"item_name">weather.ipynb</span></a><div class=3D"pull-right"><div clas=
s=3D"item_buttons pull-left"><div class=3D"running-indicator" style=3D"visi=
bility: hidden;">Running</div></div><div class=3D"pull-right"><span class=
=3D"item_modified pull-left" title=3D"2022-12-12 14:57">5 days ago</span><s=
pan class=3D"file_size pull-right">103 kB</span></div></div></div></div><di=
v class=3D"list_item row"><div class=3D"col-md-12"><input type=3D"checkbox"=
 title=3D"Click here to rename, delete, etc."><i class=3D"item_icon noteboo=
k_icon icon-fixed-width"></i><a class=3D"item_link" href=3D"http://localhos=
t:8888/notebooks/webscraping.ipynb" target=3D"_blank"><span class=3D"item_n=
ame">webscraping.ipynb</span></a><div class=3D"pull-right"><div class=3D"it=
em_buttons pull-left"><div class=3D"running-indicator" style=3D"visibility:=
 hidden;">Running</div></div><div class=3D"pull-right"><span class=3D"item_=
modified pull-left" title=3D"2022-11-25 12:49">22 days ago</span><span clas=
s=3D"file_size pull-right">5.53 kB</span></div></div></div></div><div class=
=3D"list_item row"><div class=3D"col-md-12"><input type=3D"checkbox" title=
=3D"Click here to rename, delete, etc."><i class=3D"item_icon file_icon ico=
n-fixed-width"></i><a class=3D"item_link" href=3D"http://localhost:8888/edi=
t/Cleandataset-Train" target=3D"_blank"><span class=3D"item_name">Cleandata=
set-Train</span></a><div class=3D"pull-right"><div class=3D"item_buttons pu=
ll-left"><div class=3D"running-indicator" style=3D"visibility: hidden;">Run=
ning</div></div><div class=3D"pull-right"><span class=3D"item_modified pull=
-left" title=3D"2022-11-13 09:30">a month ago</span><span class=3D"file_siz=
e pull-right">67.7 kB</span></div></div></div></div><div class=3D"list_item=
 row"><div class=3D"col-md-12"><input type=3D"checkbox" title=3D"Click here=
 to rename, delete, etc."><i class=3D"item_icon file_icon icon-fixed-width"=
></i><a class=3D"item_link" href=3D"http://localhost:8888/edit/movierecomme=
ndation.py" target=3D"_blank"><span class=3D"item_name">movierecommendation=
.py</span></a><div class=3D"pull-right"><div class=3D"item_buttons pull-lef=
t"><div class=3D"running-indicator" style=3D"visibility: hidden;">Running</=
div></div><div class=3D"pull-right"><span class=3D"item_modified pull-left"=
 title=3D"2022-12-17 15:09">3 minutes ago</span><span class=3D"file_size pu=
ll-right">260 kB</span></div></div></div></div><div class=3D"list_item row"=
><div class=3D"col-md-12"><input type=3D"checkbox" title=3D"Click here to r=
ename, delete, etc."><i class=3D"item_icon file_icon icon-fixed-width"></i>=
<a class=3D"item_link" href=3D"http://localhost:8888/edit/movies.pkl" targe=
t=3D"_blank"><span class=3D"item_name">movies.pkl</span></a><div class=3D"p=
ull-right"><div class=3D"item_buttons pull-left"><div class=3D"running-indi=
cator" style=3D"visibility: hidden;">Running</div></div><div class=3D"pull-=
right"><span class=3D"item_modified pull-left" title=3D"2022-12-17 14:57">1=
5 minutes ago</span><span class=3D"file_size pull-right">2.22 MB</span></di=
v></div></div></div><div class=3D"list_item row"><div class=3D"col-md-12"><=
input type=3D"checkbox" title=3D"Click here to rename, delete, etc."><i cla=
ss=3D"item_icon file_icon icon-fixed-width"></i><a class=3D"item_link" href=
=3D"http://localhost:8888/edit/similarity.pkl" target=3D"_blank"><span clas=
s=3D"item_name">similarity.pkl</span></a><div class=3D"pull-right"><div cla=
ss=3D"item_buttons pull-left"><div class=3D"running-indicator" style=3D"vis=
ibility: hidden;">Running</div></div><div class=3D"pull-right"><span class=
=3D"item_modified pull-left" title=3D"2022-12-17 14:58">13 minutes ago</spa=
n><span class=3D"file_size pull-right">185 MB</span></div></div></div></div=
>
          </div>
        </div>
        <div id=3D"running" class=3D"tab-pane">
          <div id=3D"running_toolbar" class=3D"row list_toolbar">
            <div class=3D"col-sm-8 no-padding">
              <span id=3D"running_list_info" class=3D"toolbar_info">Current=
ly running Jupyter processes</span>
            </div>
            <div class=3D"col-sm-4 no-padding tree-buttons">
              <span id=3D"running_buttons" class=3D"pull-right toolbar_butt=
ons">
              <button id=3D"refresh_running_list" title=3D"Refresh running =
list" aria-label=3D"Refresh running list" class=3D"btn btn-default btn-xs">=
<i class=3D"fa fa-refresh"></i></button>
              </span>
            </div>
          </div>
          <div class=3D"panel-group" id=3D"accordion">
            <div class=3D"panel panel-default">
              <div class=3D"panel-heading">
                <a data-toggle=3D"collapse" data-target=3D"#collapseOne" hr=
ef=3D"http://localhost:8888/tree#">
                  Terminals
                <i class=3D"fa fa-caret-down"></i></a>
              </div>
              <div id=3D"collapseOne" class=3D" collapse in">
                <div class=3D"panel-body">
                  <div id=3D"terminal_list" class=3D"list_container">
                    <div id=3D"terminal_list_header" class=3D"row list_plac=
eholder">
                   =20
            ...
            <div class=3D"panel panel-default">
              <div class=3D"panel-heading">
                <a data-toggle=3D"collapse" data-target=3D"#collapseTwo" hr=
ef=3D"http://localhost:8888/tree#">
                  Notebooks
                <i class=3D"fa fa-caret-down"></i></a>
              </div>
              <div id=3D"collapseTwo" class=3D" collapse in">
                <div class=3D"panel-body">
                  <div id=3D"running_list" class=3D"list_container">
                    <div id=3D"running_list_placeholder" class=3D"row list_=
placeholder" style=3D"display: none;">
                      <div> There are no notebooks running. </div>
                    </div>
                  <div class=3D"list_item row"><div class=3D"col-md-12"><i =
class=3D"item_icon running_notebook_icon icon-fixed-width"></i><a class=3D"=
item_link" href=3D"http://localhost:8888/notebooks/Untitled.ipynb" target=
=3D"_blank"><span class=3D"item_name">Untitled.ipynb</span></a><div class=
=3D"pull-right"><div class=3D"item_buttons pull-left"><div class=3D"kernel-=
name">Python 3 (ipykernel)</div><button class=3D"btn btn-warning btn-xs">Sh=
utdown</button></div><div class=3D"pull-right"><span class=3D"item_modified=
 pull-left" title=3D"2022-12-17 15:12">seconds ago</span><span class=3D"fil=
e_size pull-right">&nbsp;</span></div></div></div></div><div class=3D"list_=
item row"><div class=3D"col-md-12"><i class=3D"item_icon running_notebook_i=
con icon-fixed-width"></i><a class=3D"item_link" href=3D"http://localhost:8=
888/notebooks/Movie_Recommender_system.ipynb" target=3D"_blank"><span class=
=3D"item_name">Movie_Recommender_system.ipynb</span></a><div class=3D"pull-=
right"><div class=3D"item_buttons pull-left"><div class=3D"kernel-name">Pyt=
hon 3 (ipykernel)</div><button class=3D"btn btn-warning btn-xs">Shutdown</b=
utton></div><div class=3D"pull-right"><span class=3D"item_modified pull-lef=
t" title=3D"2022-12-17 15:12">seconds ago</span><span class=3D"file_size pu=
ll-right">&nbsp;</span></div></div></div></div><div class=3D"list_item row"=
><div class=3D"col-md-12"><i class=3D"item_icon running_notebook_icon icon-=
fixed-width"></i><a class=3D"item_link" href=3D"http://localhost:8888/noteb=
ooks/movierecommendation.py" target=3D"_blank"><span class=3D"item_name">mo=
vierecommendation.py</span></a><div class=3D"pull-right"><div class=3D"item=
_buttons pull-left"><div class=3D"kernel-name">Python 3 (ipykernel)</div><b=
utton class=3D"btn btn-warning btn-xs">Shutdown</button></div><div class=3D=
"pull-right"><span class=3D"item_modified pull-left" title=3D"2022-12-17 15=
:12">seconds ago</span><span class=3D"file_size pull-right">&nbsp;</span></=
div></div></div></div></div>
                </div>
              </div>
            </div>
        ...
        <div id=3D"clusters" class=3D"tab-pane">
          Clusters tab is now provided by IPython parallel.
          See '<a href=3D"https://github.com/ipython/ipyparallel">IPython p=
arallel</a>' for installation details.
        </div>
...
nt-smoothing: antialiased; content: "=EF=84=94"; }

.notebook_icon::before { display: inline-block; font-style: normal; font-va=
riant: normal; font-weight: normal; font-stretch: normal; line-height: 1; f=
ont-family: FontAwesome; font-size: inherit; text-rendering: auto; -webkit-=
font-smoothing: antialiased; content: "=EF=80=AD"; position: relative; top:=
 -1px; }

.running_notebook_icon::before { display: inline-block; font-style: normal;=
 font-variant: normal; font-weight: normal; font-stretch: normal; line-heig=
ht: 1; font-family: FontAwesome; font-size: inherit; text-rendering: auto; =
-webkit-font-smoothing: antialiased; content: "=EF=80=AD"; position: relati=
ve; top: -1px; color: rgb(92, 184, 92); }

.file_icon::before { display: inline-block; font-style: normal; font-varian=
t: normal; font-weight: normal; font-stretch: normal; line-height: 1; font-=
family: FontAwesome; font-size: inherit; text-rendering: auto; -webkit-font=
-smoothing: antialiased; content: "=EF=80=96"; position: relative; top: -2p=
x; }
...
.dirty-indicator { display: inline-block; font-style: normal; font-variant:=
 normal; font-weight: normal; font-stretch: normal; line-height: 1; font-fa=
mily: FontAwesome; font-size: inherit; text-rendering: auto; -webkit-font-s=
moothing: antialiased; width: 20px; }
...
riant: normal; font-weight: normal; font-stretch: normal; line-height: 1; f=
ont-family: FontAwesome; font-size: inherit; text-rendering: auto; -webkit-=
font-smoothing: antialiased; width: 20px; }
...
.dirty-indicator-clean::before { display: inline-block; font-style: normal;=
 font-variant: normal; font-weight: normal; font-stretch: normal; line-heig=
ht: 1; font-family: FontAwesome; font-size: inherit; text-rendering: auto; =
-webkit-font-smoothing: antialiased; content: "=EF=80=8C"; }
...
nt-weight: normal; font-stretch: normal; line-height: 1; font-family: FontA=
wesome; font-size: inherit; text-rendering: auto; -webkit-font-smoothing: a=
ntialiased; display: block; content: "=EF=83=9A"; float: right; color: rgb(=
51, 51, 51); margin-top: 2px; margin-right: -10px; }
...
-height: 1; font-family: FontAwesome; font-size: inherit; text-rendering: a=
uto; -webkit-font-smoothing: antialiased; content: "=EF=81=80"; }

.command_mode .modal_indicator::before { display: inline-block; font-style:=
 normal; font-variant: normal; font-weight: normal; font-stretch: normal; l=
ine-height: 1; font-family: FontAwesome; font-size: inherit; text-rendering=
: auto; -webkit-font-smoothing: antialiased; content: " "; }
...
; font-family: FontAwesome; font-size: inherit; text-rendering: auto; -webk=
it-font-smoothing: antialiased; content: "=EF=84=8C"; }

.kernel_busy_icon::before { display: inline-block; font-style: normal; font=
-variant: normal; font-weight: normal; font-stretch: normal; line-height: 1=
; font-family: FontAwesome; font-size: inherit; text-rendering: auto; -webk=
it-font-smoothing: antialiased; content: "=EF=84=91"; }

.kernel_dead_icon::before { display: inline-block; font-style: normal; font=
-variant: normal; font-weight: normal; font-stretch: normal; line-height: 1=
; font-family: FontAwesome; font-size: inherit; text-rendering: auto; -webk=
it-font-smoothing: antialiased; content: "=EF=87=A2"; }
...
eight: 1; font-family: FontAwesome; font-size: inherit; text-rendering: aut=
o; -webkit-font-smoothing: antialiased; content: "=EF=84=A7"; }
